...
var client = algoliasearch(process.env.ALGOLIA_APP, process.env.ALGOLIA_API_KEY);
var algolia = client.initIndex(process.env.ALGOLIA_INDEX);

algolia.setSettings({
	'removeStopWords':[true,'es']
});
...
//gets current index
request('https://sambogr.netlify.com/index.json', function (error, response, body) {
